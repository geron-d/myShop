...
public class Paths {
    ...
    public static final String PRODUCT_PATH = "/pages/products/product.jsp";
    public static final String PRODUCT_ADDED_TO_BUCKET_PATH = "/pages/products/productAddedToBucket.jsp";
